...
void main() {
  ...
  for (final stock in stockList) {
    ...
    group('$name($code) 详细分析调试', () {
      ...
      test('$code 全量分析输出', () async {
        print('\n\n' + '='*70);
        print('           $name($code) 详细分析测试');
        print('='*70);
        ...
        if (mp != null) {
          print('  persistenceScore: ${mp['persistence_score']?.toStringAsFixed(4)}');
          print('  adxTrendScore: ${mp['adx_trend_score']?.toStringAsFixed(4)}');
          print('  volumeConfirmScore: ${mp['volume_confirm_score']?.toStringAsFixed(4)}');
          print('  priceDeviationScore: ${mp['price_deviation_score']?.toStringAsFixed(4)}');
        ...
        if (np != null) {
          print('  upProbability: ${np['up_probability']?.toStringAsFixed(4)}');
          print('  downProbability: ${np['down_probability']?.toStringAsFixed(4)}');
          print('  neutralProbability: ${np['neutral_probability']?.toStringAsFixed(4)}');
          print('  sampleCount: ${np['sample_count']}');
        ...
        print('\n--- 预警信号 ---');
        final ew = analysis.earlyWarningSignals;
