...
void main() {
  test('neutral data returns score 5 observation and v2 model', () {
    ...
    expect(result.decision.modelVersion, 'short-term-v2');
  });
...
List<HistoryKline> _data({required int trend}) {
