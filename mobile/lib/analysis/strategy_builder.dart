...
class StrategyBuilder {
  ...
  static List<TradingStrategy> getAllStrategyDefinitions() {
    return [
      // ── 短线策略（6个）──
      TradingStrategy(
        id: 'kdj_short_buy', name: 'KDJ超卖金叉', category: '短线',
        description: 'KDJ在超卖区（K<30）形成金叉，短线反弹信号，适合1-3天操作',
        entryRule: 'K线上穿D线且K值<30，立即入场',
        exitRule: 'K值>80或K线下穿D线，立即离场',
        stopLossRule: '跌破入场价-1.5xATR',
        isActive: false, signalStrength: 75, type: 'buy',
        strategyType: 'short', recommendedDuration: 3,
        maxDrawdown: 0.05, consecutiveLossLimit: 2, minConfidence: 0.65,
        riskRewardRatio: 2.0, compatibleIndicators: ['KDJ', 'RSI'],
      ),
      TradingStrategy(
        id: 'macd_short_divergence', name: 'MACD底背离短线', category: '短线',
        description: '股价创新低但MACD不创新低，下跌动能衰竭，短线反弹机会',
        entryRule: '底背离确认后，DIF开始拐头向上时入场',
        exitRule: 'DIF再次向下拐头或跌破入场价', stopLossRule: '跌破入场价-1.5xATR',
        isActive: false, signalStrength: 80, type: 'buy',
        strategyType: 'short', recommendedDuration: 5,
        maxDrawdown: 0.06, consecutiveLossLimit: 3, minConfidence: 0.70,
        riskRewardRatio: 2.5, compatibleIndicators: ['MACD', 'RSI'],
      ),
      TradingStrategy(
        id: 'shrink_pullback_short', name: '缩量回调', category: '短线',
        description: '上涨趋势中缩量回调，抛压减轻，短线逢低买入机会',
        entryRule: '量能萎缩至均量70%以下，股价回踩均线企稳',
        exitRule: '放量下跌或跌破MA20', stopLossRule: '跌破入场价-1.5xATR',
        isActive: false, signalStrength: 70, type: 'buy',
        strategyType: 'short', recommendedDuration: 5,
        maxDrawdown: 0.05, consecutiveLossLimit: 3, minConfidence: 0.60,
        riskRewardRatio: 2.0, compatibleIndicators: ['MA', '量价'],
      ),
      TradingStrategy(
        id: 'rsi_oversold_short', name: 'RSI超卖反弹', category: '短线',
        description: 'RSI从超卖区回升突破30，短线反弹信号',
        entryRule: 'RSI6从30以下回升突破30', exitRule: 'RSI6>70或RSI6再次跌破50',
        stopLossRule: '跌破入场价-1.5xATR',
        isActive: false, signalStrength: 65, type: 'buy',
        strategyType: 'short', recommendedDuration: 3,
        maxDrawdown: 0.05, consecutiveLossLimit: 2, minConfidence: 0.60,
        riskRewardRatio: 1.8, compatibleIndicators: ['RSI'],
      ),
      TradingStrategy(
        id: 'ma_breakout_short', name: '均线突破', category: '短线',
        description: '股价向上突破5日均线，短期走势转强',
        entryRule: '股价站上MA5', exitRule: '股价跌破MA5',
        stopLossRule: '跌破入场价-1.5xATR',
        isActive: false, signalStrength: 60, type: 'buy',
        strategyType: 'short', recommendedDuration: 3,
        maxDrawdown: 0.04, consecutiveLossLimit: 2, minConfidence: 0.55,
        riskRewardRatio: 1.5, compatibleIndicators: ['MA'],
      ),
      TradingStrategy(
        id: 'volume_breakout_short', name: '放量突破', category: '短线',
        description: '成交量放大至均量2倍以上，股价上涨，短线买入信号',
        entryRule: '量比>2且股价上涨', exitRule: '连续3日缩量或跌破突破日收盘价',
        stopLossRule: '跌破入场价-1.5xATR',
        isActive: false, signalStrength: 75, type: 'buy',
        strategyType: 'short', recommendedDuration: 5,
        maxDrawdown: 0.05, consecutiveLossLimit: 2, minConfidence: 0.65,
        riskRewardRatio: 2.0, compatibleIndicators: ['量价', 'MA'],
      ),
      // ── 长线策略（6个）──
      TradingStrategy(
        id: 'ma_multi_head_long', name: '均线多头排列', category: '长线',
        description: 'MA5>MA10>MA20>MA60，长期上升趋势，中线持股为主',
        entryRule: '多头排列形成后，股价回踩MA10附近企稳',
        exitRule: 'MA5下穿MA10或跌破MA20', stopLossRule: '跌破入场价-2xATR',
        isActive: false, signalStrength: 85, type: 'buy',
        strategyType: 'long', recommendedDuration: 30,
        maxDrawdown: 0.08, consecutiveLossLimit: 4, minConfidence: 0.70,
        riskRewardRatio: 2.0, compatibleIndicators: ['MA', 'MACD'],
      ),
      TradingStrategy(
        id: 'macd_zero_above_cross', name: 'MACD零轴上方金叉', category: '长线',
        description: 'MACD在零轴上方形成金叉，多头趋势强劲，中线持股为主',
        entryRule: 'MACD在零轴上方DIF上穿DEA',
        exitRule: 'MACD柱连续缩短3日或DIF下穿DEA', stopLossRule: '跌破入场价-2xATR',
        isActive: false, signalStrength: 90, type: 'buy',
        strategyType: 'long', recommendedDuration: 45,
        maxDrawdown: 0.08, consecutiveLossLimit: 4, minConfidence: 0.75,
        riskRewardRatio: 2.0, compatibleIndicators: ['MACD', 'MA'],
      ),
      TradingStrategy(
        id: 'rsi_support_long', name: 'RSI中轨支撑', category: '长线',
        description: 'RSI在40-60区间运行，中轨附近企稳，长期持有',
        entryRule: 'RSI12在40-60区间，股价回踩MA10企稳',
        exitRule: 'RSI12>70或RSI12<30', stopLossRule: '跌破入场价-2xATR',
        isActive: false, signalStrength: 70, type: 'buy',
        strategyType: 'long', recommendedDuration: 30,
        maxDrawdown: 0.06, consecutiveLossLimit: 3, minConfidence: 0.65,
        riskRewardRatio: 1.8, compatibleIndicators: ['RSI', 'MA'],
      ),
      TradingStrategy(
        id: 'boll_breakout_long', name: '布林带突破', category: '长线',
        description: '布林带收口后放量突破上轨，向上趋势确立，中线持有',
        entryRule: '布林带收口后放量突破上轨',
        exitRule: '股价回落至中轨下方', stopLossRule: '跌破入场价-2xATR',
        isActive: false, signalStrength: 80, type: 'buy',
        strategyType: 'long', recommendedDuration: 30,
        maxDrawdown: 0.07, consecutiveLossLimit: 3, minConfidence: 0.70,
        riskRewardRatio: 2.0, compatibleIndicators: ['BOLL', 'MACD'],
      ),
      TradingStrategy(
        id: 'adx_trend_long', name: '趋势强度确认', category: '长线',
        description: 'ADX>25且+DI>-DI，趋势明确，可顺势而为，长期持有',
        entryRule: 'ADX>25且+DI>-DI，趋势强度强劲',
        exitRule: 'ADX<20或趋势转弱', stopLossRule: '跌破入场价-2xATR',
        isActive: false, signalStrength: 75, type: 'buy',
        strategyType: 'long', recommendedDuration: 45,
        maxDrawdown: 0.08, consecutiveLossLimit: 4, minConfidence: 0.75,
        riskRewardRatio: 1.8, compatibleIndicators: ['ADX', 'MA'],
      ),
      TradingStrategy(
        id: 'breakout_pullback_confirm', name: '突破+回踩确认', category: '长线',
        description: '均线多头排列后回踩MA10企稳，最佳入场时机，中线持有',
        entryRule: '多头排列后回踩MA10附近不破',
        exitRule: 'MA5下穿MA10或跌破MA20', stopLossRule: '跌破入场价-2xATR',
        isActive: false, signalStrength: 85, type: 'buy',
        strategyType: 'long', recommendedDuration: 20,
        maxDrawdown: 0.05, consecutiveLossLimit: 3, minConfidence: 0.70,
        riskRewardRatio: 2.0, compatibleIndicators: ['MA', 'MACD'],
      ),
      // ── 特殊策略（1个）──
      TradingStrategy(
        id: 'volume_stop_drop', name: '缩量止跌', category: '特殊',
        description: '前期大幅下跌后量能萎缩，价格企稳，止跌信号',
        entryRule: '前期跌幅超10%后量能萎缩至均量50%以下，价格企稳',
        exitRule: '放量上涨或跌破企稳价位', stopLossRule: '跌破入场价-1.5xATR',
        isActive: false, signalStrength: 65, type: 'buy',
        strategyType: 'both', recommendedDuration: 15,
        maxDrawdown: 0.05, consecutiveLossLimit: 2, minConfidence: 0.60,
